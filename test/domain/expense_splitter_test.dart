...
void main() {
  group('splitEqually', () {
    test(
      'sums to exactly the original amount for a range of amounts/participant counts',
      () {
        ...
        for (final amount in amounts) {
          for (
            ...
            expect(
              ...
              amount,
              reason:
                  'amount=$amount, n=$participantCount must not lose or gain a so\'m',
            );
    ...
    test(
      '100 000 so\'m split 3 ways: two people get 33 334, one gets 33 333',
      () {
  ...
  group('validateCustomShares', () {
    test(
      'accepts shares that exactly cover the participants and sum to the amount',
      () {
